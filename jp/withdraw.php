...
if(!empty($_POST)){
  ...
  try {
    ...
    $sql2 = 'UPDATE infoblog SET  delete_flg = 1 WHERE user_id = :us_id';
        ...
        <div class="form-container">
          <form action="" method="post" class="form">
            ...
            <div class="btn-container">
              <input type="submit" class="btn btn-mid" value="管理権限を削除する" name="submit">
            </div>
          </form>
        </div>
        <a href="login.php">&lt; 管理画面ログインに戻る</a>
      </section>
    </div>
